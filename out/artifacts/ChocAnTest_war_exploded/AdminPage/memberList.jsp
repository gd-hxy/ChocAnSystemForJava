  ...
  <div class="row">
    <div class="col-sm-12 offset-sm-0">
      ...
      <div class="panel-body">
        <ul>
          <li>用户id: ${memberEntity.getMemberId()}</li>
          <li>用户名： ${memberEntity.getMemberName()}</li>
          <li>所在国家： ${memberEntity.getMemberCountry()}</li>
          <li>所在城市： ${memberEntity.getMemberCity()}</li>
          <li>详细地址： ${memberEntity.getMemberAddress()}</li>
          <li>用户ZIP码： ${memberEntity.getMemberZip()}</li>
        </ul>
      </div>
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <table class="table table-striped table-bordered table-hover dataTables-example">
            ...
            <tbody>
            <c:forEach items="${memberLists}" var="memberList" varStatus="status">
              <tr>
                <td>${memberList.getServiceName()}</td>
                <td>${memberList.getProviderName()}</td>
                <td>${memberList.getServiceDate()}</td>
              </tr>
            </c:forEach>
            </tbody>
          </table>

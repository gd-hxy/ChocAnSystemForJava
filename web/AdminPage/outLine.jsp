  ...
  <div class="row">
    <div class="col-sm-12 offset-sm-0">
      ...
      <div class="panel-body">
        <ul>
          <li>提供服务的提供者总数: ${providerTotalNumber}</li>
          <li>咨询总数： ${queryTotalNumber}</li>
          <li>总的支付费用： ${TotalFee}</li>
        </ul>
      </div>
      <div class="ibox float-e-margins">
        ...
        <div class="ibox-content">
          <table class="table table-striped table-bordered table-hover dataTables-example">
            ...
            <tbody>
            <c:forEach items="${outLines}" var="outLine" varStatus="status">
              <tr>
                <td>${outLine.getProviderId()}</td>
                <td>${outLine.getProviderName()}</td>
                <td>${outLine.getQueryAmount()}</td>
                <td>${outLine.getTotalFee()}</td>
              </tr>
            </c:forEach>
            </tbody>
          </table>
